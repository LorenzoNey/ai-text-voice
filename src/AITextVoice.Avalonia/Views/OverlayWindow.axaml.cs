...
public partial class OverlayWindow : Window
{
    ...
    private static void Log(string message)
    {
        try
        {
            var logDir = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "AITextVoice", "logs");
            Directory.CreateDirectory(logDir);
            var logFile = Path.Combine(logDir, $"aitextvoice_{DateTime.Now:yyyy-MM-dd}.log");
