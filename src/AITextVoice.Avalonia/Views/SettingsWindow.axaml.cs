...
public partial class SettingsWindow : Window
{
    ...
    private async void DownloadFasterWhisperButton_Click(object? sender, RoutedEventArgs e)
    {
        ...
        try
        {
            var helper = new global::AITextVoice.Services.DownloadHelper();
    ...
    // Piper Voice Catalog
    private AITextVoice.Models.PiperVoiceCatalog? _voiceCatalog;
    private List<AITextVoice.Models.PiperVoiceEntry> _filteredVoices = new();
    ...
    private void FilterVoiceCatalog()
    {
        ...
        var installedVoices = new global::AITextVoice.Services.DownloadHelper().GetInstalledPiperVoices();
