...
public class DownloadHelper
{
    ...
    /// - Windows: %APPDATA%\AITextVoice
    /// - macOS: ~/Library/Application Support/AITextVoice
    /// - Linux: ~/.local/share/AITextVoice
    /// </summary>
    public static string GetDataDirectory()
    {
        ...
        var dataDir = Path.Combine(baseDir, "AITextVoice");
    ...
    public DownloadHelper(ILoggingService? loggingService = null)
    {
        ...
        _httpClient.DefaultRequestHeaders.UserAgent.ParseAdd("AITextVoice/1.0");
