...
namespace AITextVoice.Services.Speech;
...
public class WhisperServerSpeechRecognitionService : ISpeechRecognitionService
{
    ...
    private static readonly string PidFilePath = Path.Combine(
        ...
        "AITextVoice", "whisper-server.pid");
    ...
    /// <summary>
    /// Kills only the whisper-server process that AITextVoice previously started (tracked via PID file).
