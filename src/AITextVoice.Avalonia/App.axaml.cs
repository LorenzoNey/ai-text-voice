...
using AITextVoice.Infrastructure.Keyboard;
using AITextVoice.Models;
using AITextVoice.Services;
using AITextVoice.Services.Interfaces;
using AITextVoice.Services.Speech;
using AITextVoice.Services.Tts;
using AITextVoice.ViewModels;
using AITextVoice.Views;
...
public partial class App : Application
{
    ...
    private void OnUpdateAvailable(object? sender, UpdateAvailableEventArgs e)
    {
        Dispatcher.UIThread.Post(() =>
        {
            ...
            if (_trayIcon != null)
            {
                _trayIcon.ToolTipText = $"AITextVoice - Update Available (v{e.LatestVersion.Major}.{e.LatestVersion.Minor}.{e.LatestVersion.Build})";
            }
        });
    }
    ...
    private void SetupTrayIcon()
    {
        ...
        _trayIcon = new TrayIcon
        {
            ...
            ToolTipText = "AITextVoice - Ready (Ctrl+Ctrl to start)",
    ...
    {
        // The native menu is defined in App.axaml with "About AITextVoice"
    ...
    {
        var uri = new Uri($"avares://AITextVoice/Resources/Icons/{iconName}");
    ...
    private async Task DownloadFileAsync(string url, string destinationPath)
    {
        ...
        httpClient.DefaultRequestHeaders.UserAgent.ParseAdd("AITextVoice/1.0");
