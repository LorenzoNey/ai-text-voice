; AITextVoice Installer Script for Inno Setup
; https://jrsoftware.org/isinfo.php

#define MyAppName "AITextVoice"
#define MyAppVersion "1.2.0"
#define MyAppPublisher "AITextVoice"
#define MyAppExeName "AITextVoice.exe"
#define MyAppDescription "AI-powered speech-to-text and text-to-speech tool"
...
; Output settings
OutputDir=.\output
OutputBaseFilename=AITextVoice-Setup-{#MyAppVersion}
; Installer icon
SetupIconFile=..\..\src\AITextVoice.Avalonia\Resources\Icons\app_icon.ico
